...
import 'package:getx_clean_architecture/common/network/dio_client.dart';
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          when(mockDioClient.post<User>(ApiConfig.users,
          ...
          bool result =
              await userRemoteDataSourceImpl.createUser(tUserDummyObject);
    ...
    () {
      test(
        ...
        () async {
          ...
          bool result =
              await userRemoteDataSourceImpl.deleteUser(tUserDummyObject);
      ...
      test(
        ...
        () async {
          ...
          try {
            when(mockDioClient.post<User>(tUserDummyUrl,
                    data: tUserDummyObject))
                .thenThrow(
              (_) async => DioException(
                requestOptions: RequestOptions(),
  ...
  group(
    ...
    () {
      test(
        'should return true when the response code is 200',
        () async {
          when(mockDioClient.put<User>(tUserDummyUrl, data: tUserDummyObject))
              .thenAnswer(
            (_) async => Response<User>(
              statusCode: 200,
              requestOptions: RequestOptions(),
          ...
          bool result =
              await userRemoteDataSourceImpl.updateUser(tUserDummyObject);
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          when(mockDioClient.get(ApiConfig.users,
              queryParameters: <String, String>{})).thenAnswer(
            (_) async {
          ...
          List<User> users =
              await userRemoteDataSourceImpl.getUsers(gender: null);
      ...
      test(
        ...
        () async {
          ...
          try {
            when(mockDioClient.get<User>(ApiConfig.users,
                queryParameters: <String, String>{})).thenThrow(
              (_) async => DioException(
                requestOptions: RequestOptions(),
                type: DioExceptionType.connectionError,
              ),
      ...
      test(
        ...
        () async {
          ...
          List<User> users =
              await userRemoteDataSourceImpl.getUsers(gender: Gender.male);
      ...
      test(
        ...
        () async {
          ...
          User userObjectContainFemale =
              tUserDummyObject.copyWith(gender: Gender.female);
          ...
          List<User> users =
              await userRemoteDataSourceImpl.getUsers(gender: Gender.female);
      ...
      test(
        ...
        () async {
          ...
          List<User> users = await userRemoteDataSourceImpl.getUsers(
      ...
      test(
        ...
        () async {
          ...
          User userObjectContainActiveUsers =
              tUserDummyObject.copyWith(status: UserStatus.active);
      ...
      test(
        ...
        () async {
          ...
          List<User> users = await userRemoteDataSourceImpl.getUsers(
              status: UserStatus.inactive, gender: Gender.male);
