...
import 'package:getx_clean_architecture/common/network/dio_exception.dart';
import 'package:getx_clean_architecture/core/app_string.dart';
...
import 'package:getx_clean_architecture/features/user/data/repositories/user_repository_impl.dart';
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          when(mockUserRemoteDataSource.createUser(tUserDummyObject))
              .thenAnswer(
            (_) async => true,
          );
            ...
            expect(
              ...
              allOf(
                ...
                predicate<DioExceptions>(
                  (exception) =>
                      exception.message == AppString.connectionTimeOut,
                ),
              ),
            );
          }
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          when(mockUserRemoteDataSource.updateUser(tUserDummyObject))
              .thenAnswer(
            (_) async => true,
          );
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          when(mockUserRemoteDataSource.deleteUser(tUserDummyObject))
              .thenAnswer(
            (_) async => true,
          );
