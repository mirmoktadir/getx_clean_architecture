...
import 'package:getx_clean_architecture/features/user/presentation/controllers/user_controller.dart';
    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          when(mockUpdateUserUseCase.call(any))
              .thenAnswer((_) async => const Left(tDummyExceptionMsg));
    ...
    () {
      test(
        ...
        () async {
          ...
          when(mockDeleteUserUseCase.call(any))
              .thenAnswer((_) async => const Right(true));
      ...
      test(
        ...
        () async {
          when(mockGetUsersUseCase.call(any))
              .thenAnswer((_) async => const Right([tUserDummyObject]));
